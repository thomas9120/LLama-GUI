...
const FLAGS = [
    ...
    { id: "ctx_size", flag: "-c", category: "context", type: "int", label: "Total Context Window",
      desc: "Total context size in tokens. This is the maximum number of tokens the model can 'remember' at once, including your prompt, system prompt, conversation history, AND the model's reply. Larger values use more VRAM/RAM. Set 0 to use the model's default.", tool: "both", default: 0, min: 0, max: 131072, placeholder: "0 = from model" },

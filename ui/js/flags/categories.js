// Flags package: the FLAG_CATEGORIES array - display grouping for the FLAGS entries.
...
const FLAG_CATEGORIES = [
	...
	{ id: "speculative", name: "Speculative Decoding", icon: "⚡", submenuOrder: ["Ngram Simple", "Ngram Mod", "Ngram Map K4V"] },

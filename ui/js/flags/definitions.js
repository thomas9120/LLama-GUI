const FLAGS = [
	...
	},
	{
		...
		category: "context",
		type: "int",
		label: "KV Cache RAM Limit (MiB)",
		desc: "Maximum RAM/VRAM to use for the KV cache in MiB. The KV cache stores conversation history - more cache = longer conversations before older messages are evicted. -1 = no limit, 0 = disable.",
		tool: "both",
		default: 8192,
		min: -1,
		placeholder: "-1 unlimited",

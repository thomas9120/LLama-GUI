const FLAGS = [
    ...
    { id: "ctx_size", flag: "-c", category: "context", type: "int", label: "Total Context Window",
      ...
      beginner_tip: "32768 is a strong default. Lower it if you run out of memory.",
      desc: "Total context size in tokens. This is the maximum number of tokens the model can 'remember' at once, including your prompt, system prompt, conversation history, AND the model's reply. Larger values use more VRAM/RAM. Set 0 to use the model's default.", tool: "both", default: 32768, min: 0, max: 262144, placeholder: "32768 recommended" },
    ...
    { id: "fit", flag: "-fit", category: "auto_fit", type: "enum", label: "Auto Fit to VRAM",
    ...
    { id: "fit_target", flag: "-fitt", category: "auto_fit", type: "text", label: "Fit Target Margin",
    ...
    { id: "fit_ctx", flag: "-fitc", category: "auto_fit", type: "int", label: "Minimum Auto Fit Context",
      ...
      default: 32768, min: 0, max: 262144, placeholder: "32768" },
   ...
   { id: "repeat_penalty", flag: "--repeat-penalty", category: "sampling", type: "float", label: "Repeat Penalty",
    ...
    { id: "override_tensor", flag: "-ot", category: "advanced", type: "text", label: "Tensor Buffer Overrides",
      short_desc: "Force matching model tensors onto a specific backend buffer, such as CPU or CUDA0.",
      ...
      tool: "both", placeholder: "blk.*.ffn_.*_exps.weight=CPU" },
